-- Migration script: Drop old tables and create new structure
-- Run this with: wrangler d1 execute stocktakedata --file=./migrate-schema.sql --remote
...
-- Stock Items table (new structure)
